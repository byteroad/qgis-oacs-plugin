...
![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/byteroad/qgis-oacs-plugin?include_prereleases)
![GitHub](https://img.shields.io/github/license/byteroad/qgis-oacs-plugin)
